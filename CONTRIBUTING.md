...
Welcome to `hackaton` contributor's guide.
...
If you experience bugs or general issues with `hackaton`, please have a look
...
You can help improve `hackaton` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`hackaton` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `hackaton`'s files. While this mechanism can
...
```
conda create -n hackaton python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/hackaton.git
   cd hackaton
   ```
...
5. Install [pre-commit]:
   ...
   `hackaton` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/hackaton
[issue tracker]: https://github.com/<USERNAME>/hackaton/issues
